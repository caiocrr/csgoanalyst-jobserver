...
object GetAttackers extends spark.jobserver.SparkJob with spark.jobserver.NamedRddSupport {
  ...
  override def runJob(sc: SparkContext, config: Config): Any = {
    ...
    val attackers = demo.map(line => line.split(',')).map(fields => new Attacker((fields(9),fields(10),fields(11),fields(12),fields(13),fields(14),fields(15),fields(16),fields(17),fields(18),fields(19))))
    
    attackers.collect().foreach(println)
